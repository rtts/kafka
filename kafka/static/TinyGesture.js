...
TinyGesture.defaults = {
  threshold: (type, self) => 20, // Math.max(25, Math.floor(0.15 * (type === 'x' ? window.innerWidth || document.body.clientWidth : window.innerHeight || document.body.clientHeight))),
  velocityThreshold: 0, //10,
  disregardVelocityThreshold: (type, self) => 20, // Math.floor(0.5 * (type === 'x' ? self.element.clientWidth : self.element.clientHeight)),
  pressThreshold: 8,
